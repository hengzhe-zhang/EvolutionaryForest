...
def resxo(phi_p1, phi_p2, beta_p1, y):
    ...
    d = np.random.randint(n_features_p1)
    phi_d = phi_p1[:, d]
...
def stagexo(phi_p1, phi_p2, y):
    ...
    while phi_c.shape[1] < n_features_p1:
        ...
        # Step 3(e): Remove phi^* from phi_A
...
if __name__ == "__main__":
    ...
    phi_p1 = np.random.rand(100, 10)  # 100 samples, 10 features for parent 1
    phi_p2 = np.random.rand(100, 15)  # 100 samples, 15 features for parent 2
