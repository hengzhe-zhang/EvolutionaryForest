...
from deap.tools import selNSGA2, History, selBest, cxTwoPoint, mutFlipBit, selDoubleTournament, selSPEA2, \
    selTournamentDCD
...
class EvolutionaryForestRegressor(RegressorMixin, TransformerMixin, BaseEstimator):
    ...
    def eaSimple(self, population, toolbox, cxpb, mutpb, ngen, stats=None,
        ...
        while number_of_evaluations < total_evaluations:
            ...
            adaptive_hoist_probability = self.hoist_mutation(population,
                                                             adaptive_hoist_probability,
